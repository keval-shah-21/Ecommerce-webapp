      ...
      <article class="card-body">
		...
		<form name="myform" action="Registration" method="POST">
				<div class="form-row">
					<div class="col form-group">
						<label>First name<span>*</span></label>
					  	<input type="text" class="form-control" placeholder="" name="fname" onblur="checkFname()">
					  	<span id="fnamespan"></span>
					</div> <!-- form-group end.// -->
					<div class="col form-group">
						<label>Last name<span>*</span></label>
					  	<input type="text" class="form-control" placeholder="" name="lname" onblur="checkLname()">
				...
				<label>Email<span>*</span></label>
					<input type="email" class="form-control" placeholder="e.g. abc123@gmail.com" name="email" onblur="checkEmail()"	>
				...
				<div class="form-row">
					...
					<input type="text" class="form-control" placeholder="10 digit phone number" name="phoneno" onblur="checkPhone()">
					<span id="phonenospan"></span>
					</div> <!-- form-group end.// -->
					<div class="col form-group">
					<label>Salary<span>*</span></label>
					<input type="text" class="form-control" placeholder="" name="salary" onblur="checkSalary()">
				...
				<div class="form-group">
            		...
            		<textarea  name="add1" class="form-control" rows="5" cols="35" onblur="checkAddress()"></textarea>

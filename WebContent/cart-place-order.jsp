...
<!-- ============================ COMPONENT REGISTER   ================================= -->
	<div class="card mx-auto" style="max-width:520px; margin-top:40px;">
      <article class="card-body">
		...
		<form  action="CartPaymentServlet" method="POST">
...
<%-- 							<input type="hidden" name="orderquantity" value="<%=orderQuantity%>"> --%>
							...
							<input type="hidden" name="productquantitys" value="<%=productQuantitys%>">
...
<%-- 						<textarea readonly="true" name="add1" class="form-control" rows="5" cols="35" value="<%=productDiscription%>"><%=productDiscription %></textarea> --%>
				...
				<input type="radio" name="payment" id="cod" value="cash on delivery">  Cash on delivery<br>   
				<input type="radio" name="payment" id="online" value="online">  Online payment<br>

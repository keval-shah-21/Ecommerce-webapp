...
<%Category category = new Category(); 
	category = (Category)request.getAttribute("categoryDetail");%>
<!-- ========================= SECTION CONTENT ========================= -->
...
<!-- ============================ COMPONENT LOGIN   ================================= -->
	<div class="card mx-auto" style="max-width: 380px; margin-top:100px;">
      ...
      <form name="myform" action="EditCategory" method="post">
      	  
          <div class="col form-group">
          	<label>Category name</label>
          	<input name="cid" class="form-control" placeholder="" type="hidden" value="<%=category.getCategoryId()%>">
			 <input name="cname" class="form-control" placeholder="" type="text" value="<%=category.getCategoryName()%>">
			 <input name="cstatus" class="form-control" placeholder="" type="hidden" value="<%=category.getStatus()%>">
			 <span id="cspan"></span>
          </div> <!-- form-group// -->

...
<!-- 		* - Mandatory Fields -->
				...
				<div class="form-row">
					<div class="col form-group">
						...
						<input id="productdis" class="form-control" type="text" readonly=true value="<%=productDiscription%>"></input>
...
<!-- 						<input class="form-control" type="text"  ></input> -->
				 ...
				 <div class="form-group">
			          ...
			          <%} %>
			          <%if(!paymentMethod.equalsIgnoreCase("online")) {%>
			          	<input id="paynow" value="Place Order" class="btn btn-primary btn-block" type="submit"	onclick="">
			          <%} %>
			    </div>      
	</form>
	</header>

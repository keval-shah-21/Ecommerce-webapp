...
<%productList = (List)request.getAttribute("productDetail"); %>
<%String sort = (String)request.getAttribute("sortname"); %>
<%for(Product obj : productList) {
	System.out.println("Product Price in jsp : "+obj.getProductPrice());
}%>
<div class="container">
<br>
<br>
...
<!-- 			<strong class="mr-md-auto">32 Items found </strong> -->
			<select class="mr-2 form-control" onchange="location = this.value;">
				...
				<option value="SortProduct?id=1" selected>Low to High Price</option>
				<option value="SortProduct?id=2">High to Low Price</option></a>
				<option value="SortProduct?id=3">A to Z </option>
				<option value="SortProduct?id=4">Z to A</option>
				<option value="SortProduct?id=5">Price 10 To 50</option>
				<option value="SortProduct?id=6">Price 50 To 100</option>
				<%} %>
				<%if(sort.equalsIgnoreCase("hightolow")){ %>
				<option value="SortProduct?id=1">Low to High Price</option>
				<option value="SortProduct?id=2" selected>High to Low Price</option></a>
				<option value="SortProduct?id=3">A to Z </option>
				<option value="SortProduct?id=4">Z to A</option>
				<option value="SortProduct?id=5">Price 10 To 50</option>
				<option value="SortProduct?id=6">Price 50 To 100</option>
				<%} %>
				<%if(sort.equalsIgnoreCase("atoz")){ %>
				<option value="SortProduct?id=1">Low to High Price</option>
				<option value="SortProduct?id=2">High to Low Price</option></a>
				<option value="SortProduct?id=3" selected>A to Z </option>
				<option value="SortProduct?id=4">Z to A</option>
				<option value="SortProduct?id=5">Price 10 To 50</option>
				<option value="SortProduct?id=6">Price 50 To 100</option>
				<%} %>
				<%if(sort.equalsIgnoreCase("ztoa")){ %>
				<option value="SortProduct?id=1">Low to High Price</option>
				<option value="SortProduct?id=2">High to Low Price</option></a>
				<option value="SortProduct?id=3">A to Z </option>
				<option value="SortProduct?id=4" selected>Z to A</option>
				<option value="SortProduct?id=5">Price 10 To 50</option>
				<option value="SortProduct?id=6">Price 50 To 100</option>
				<%} %>
				<%if(sort.equalsIgnoreCase("10to50")){ %>
				<option value="SortProduct?id=1">Low to High Price</option>
				<option value="SortProduct?id=2">High to Low Price</option></a>
				<option value="SortProduct?id=3">A to Z </option>
				<option value="SortProduct?id=4">Z to A</option>
				<option value="SortProduct?id=5" selected>Price 10 To 50</option>
				<option value="SortProduct?id=6">Price 50 To 100</option>
				<%} %>
				<%if(sort.equalsIgnoreCase("50to100")){ %>
				<option value="SortProduct?id=1">Low to High Price</option>
				<option value="SortProduct?id=2">High to Low Price</option></a>
				<option value="SortProduct?id=3">A to Z </option>
				<option value="SortProduct?id=4">Z to A</option>
				<option value="SortProduct?id=5">Price 10 To 50</option>
				<option value="SortProduct?id=6" selected>Price 50 To 100</option>
				<%} %>
			</select>
...
<!--     <center><lable>Stationery</lable></center>  -->
<!--       <img src="images/stationery.jpg" alt="First slide"> -->
      
<!--     </div> -->
<!--     <div class="carousel-item"> -->
<!--       <center><lable>Key chain</lable></center> -->
<!--       <img src="images/key.jpg" alt="Second slide"> -->
<!--     </div> -->
<!--     <div class="carousel-item"> -->
<!--       <center><lable>Toys</lable></center> -->
<!--       <img src="images/toy.jpg" alt="Third slide"> -->
<!--     </div> -->
<!--   </div> -->
...
<header class="section-heading heading-line">
	<h4 class="title-section text-uppercase">Sorted Products</h4>
</header>
...
<% for(Product obj : productList) {%>
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="FetchProductDetail?id=<%=obj.getProductId() %>" class="img-wrap"> <img src="data:image/png;base64,<%=obj.getProductImage1String()%>"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title"><%=obj.getProductName() %></a>
				<div class="price mt-1">&#8377 <%=obj.getProductPrice() %></div> <!-- price-wrap.// -->
			</figcaption>
		</div>
	</div> <!-- col.// -->
	<%} %>
...
<!-- <center><a href="display-all-product.jsp" class="btn btn-primary" style="font-weight:bold;font-size:20px"> -> View All Products </a></center> -->
<!-- =============== SECTION ITEMS .//END =============== -->

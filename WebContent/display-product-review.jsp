...
function getdid(userid) {
	...
	var uid = userid;
	var strLink = "DeleteProductReview?id=" + uid;
...
<div class="container">
	...
	<jsp:include page="/FetchReviewDetails"/>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <%for(Product obj3:productList) {%>
            <%if(obj1.getProductId()==obj3.getProductId() && obj1.getUserId()==obj.getCustomerId()){ %>
                <tr>
                    <td><%=obj.getFname() %> <%=obj.getLname() %></td>
                    
                    <td><%=obj3.getProductName()%></td>
                   <td><%=obj1.getProductReview() %></td>
                    <td><button class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#exampleModalCenter"
													onclick="getdid(<%=obj1.getProductReviewId()%>)">Delete</button></td>

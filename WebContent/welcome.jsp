...
<jsp:include page="/RandomProductDetail"/>

<%List<Product> productList = new ArrayList<Product>(); %>
<%productList = (List)request.getAttribute("randomproduct");%>
<jsp:include page="/NewArrival"/>
<%List<Product> newArrivalList = new ArrayList<Product>();
	newArrivalList = (List)request.getAttribute("newarrival");%>
...
<% for(Product obj1 : newArrivalList) {%>
	
	
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="FetchProductDetail?id=<%=obj1.getProductId() %>" class="img-wrap"> <img src="data:image/png;base64,<%=obj1.getProductImage1String()%>"> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title"><%=obj1.getProductName() %></a>
				<div class="price mt-1" >&#8377 <%=obj1.getProductPrice() %></div> <!-- price-wrap.// -->
			</figcaption>
		</div>
	</div> <!-- col.// -->
	<%} %>
...
<header class="section-heading heading-line">
	<h4 class="title-section text-uppercase">All Products</h4>
</header>

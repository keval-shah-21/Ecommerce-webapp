...
<%List<Product> productSubcategoryList = new ArrayList<Product>(); %>
<%productSubcategoryList = (List)request.getAttribute("productSubcatgoryDetails"); %>
...
<%System.out.println("Product Subcategiry List :"+productSubcategoryList.size()); %>
<%if(productSubcategoryList.size()>0) {%>
<div class="row row-sm">
<% for(Product obj : productSubcategoryList) {%>
...
<%if(productSubcategoryList.size()==0) {%>
	...
	<header>
		<h4>Sorry! No Product Availabel</h4>
	</header>
<%} %>

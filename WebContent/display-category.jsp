...
<br>
<div class="container">
<jsp:include page="/FetchAllCategory"/>
	<%List<Category> allCategoryList = new ArrayList<Category>(); %>
		<%allCategoryList = (List)request.getAttribute("allcategory"); %>
		<%System.out.println(allCategoryList.size()); %>
		<a href="new-category.jsp" class="btn btn-primary"> <i class="fa fa-plus"></i> Add Category </a>
		<br>
		<br>
            ...
            <%for(Category obj : allCategoryList){ %>
                <tr>
                    <td><%=obj.getCategoryName() %></td>
                     <td><a style="color:white;"href="EditCategory?id=<%=obj.getCategoryId()%>"><button class="btn btn-primary" style="color:white;"> <i class="fa fa-pen"></i>  </button></a></td>
                    ...
                    <%} %>
                    <%if(obj.getStatus()==-1) {%>
                    <td><a style="color:white;"href="UnblockCategory?id=<%=obj.getCategoryId()%>"><button class="btn btn-primary"  style="background-color:red;" ><i>Unblock </i></button></a></td>
                    <%} %>
